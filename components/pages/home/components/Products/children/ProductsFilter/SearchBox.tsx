...
export default function SearchBox() {
  ...
  useEffect(() => {
    setSearchQuery(queries.search || "");
  }, [queries.search, resetQueries]);
    ...
    <div className="shrink-0 sm:items-end sm:justify-end flex items-center justify-center">
      <form
        ...
        <button
          type="submit"
          disabled={loading}
          className=" cursor-pointer h-12 w-12 disabled:opacity-[0.5]     bg-amber-300    backdrop-blur-sm hover:shadow-xl transition-transform duration-300 flex items-center justify-center rounded-xl "
          aria-label="Search">
