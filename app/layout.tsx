...
export const metadata: Metadata = {
  ...
  description:
    "Discover NobleWood's exclusive collection of handcrafted wooden furniture. Premium chairs, tables, bookcases, and decorative items made from the finest natural woods.",
  keywords:
    "wooden furniture, handcrafted chairs, wooden tables, bookcases, wooden decor, premium furniture, walnut furniture, oak furniture",
  authors: [{ name: "NobleWood Team" }],
  openGraph: {
    title: "NobleWood - Premium Handcrafted Wooden Furniture",
    description:
      "Premium handcrafted wooden furniture with exceptional quality",
